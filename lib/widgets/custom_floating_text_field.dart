...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget get floatingTextFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.labelMediumOnError,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.labelMediumGray700,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(-7.h, -7.v, -7.h, 34.v),
        fillColor:
